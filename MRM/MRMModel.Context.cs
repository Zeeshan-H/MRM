...
namespace SMS_Sender
{
    ...
    public partial class mrmdbEntities : DbContext
    {
        ...
        public virtual DbSet<Mem_Images> Mem_Images { get; set; }
        ...
        public virtual ObjectResult<usp_MH__Mem_UpdateSelections_Result> usp_MH__Mem_UpdateSelections(Nullable<int> memid, Nullable<int> userid, string strids, string strTPids, Nullable<short> tabid)
        {
            ...
            var strTPidsParameter = strTPids != null ?
                new ObjectParameter("strTPids", strTPids) :
                new ObjectParameter("strTPids", typeof(string));
    
            var tabidParameter = tabid.HasValue ?
                new ObjectParameter("tabid", tabid) :
                new ObjectParameter("tabid", typeof(short));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_MH__Mem_UpdateSelections_Result>("usp_MH__Mem_UpdateSelections", memidParameter, useridParameter, stridsParameter, strTPidsParameter, tabidParameter);
        }
