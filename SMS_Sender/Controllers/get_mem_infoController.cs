...
//            MF_Details mf = new MF_Details();
            ...
            //}
                ...
                if (model.GrpId >= 1 && model.GrpId <= 5)
                    mem.MemTypeId = 1;
                if (model.GrpId >= 7 && model.GrpId <= 12)
                    mem.MemTypeId = 3;
                mem.MemStatusId = 1;
                mem.ParentMemId = "0";
     ...
     //           key.ParentMemID = mem.ParentMemId;
                ...
                if(model.GrpId >= 1 && model.GrpId <=6)
                group.MFId = 0;

                if (model.GrpId >= 7 && model.GrpId <= 12)
                    group.MFId = acc.UserId;
                
                group.UserStatusId = 1;
                group.AddedBy = mem.AddedBy;
                group.AddedOn = DateTime.Now;
                group.UpdateBy = mem.AddedBy;
              ...
              //      key.TitleDesc = list.ElementAt(0).TitleDesc;
                ...
                if (model.GrpId >=1 && model.GrpId <=12)
...
//            info.MemId = model.MemId;
            ...
            info.AddedBy = mf.AddedBy;
            info.UpdateOn = DateTime.Now;
            info.UpdateBy = info.AddedBy;
...
//Update model
  //          model.MemId = info.MemId;
            ...
            //Update Model
  //          model.MFName = details.MFName;
  //          model.MFShortName = details.MFShortName;
   ...
   //         model.Altcontactno = cont.AltContactNo;
   //         model.EmailAdd = cont.EmailAdd;
   //         model.EmailAdd2 = cont.EmailAdd2;
